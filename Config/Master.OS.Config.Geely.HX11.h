/*
 * Master.OS.Config.Geely.HX11.h
 *
 *  Created on: 2020年12月2日
 *      Author: Master.HE
 */

#ifndef MASTER_OS_CONFIG_GEELY_HX11_H_
#define MASTER_OS_CONFIG_GEELY_HX11_H_

//#define __Memory_TEST__


#ifdef Master_OS_Use_BootLoader
...
//Shell
//#define Master_OS_Config_Shell

#elif defined(Master_OS_Use_Application)
...
#else
	#error "Master OS No Define Use object !!!"
#endif

#endif /* MASTER_OS_CONFIG_GEELY_HX11_H_ */
