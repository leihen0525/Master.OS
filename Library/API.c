...
{
	return SysCall(SysCall_Table_Index_BSP_System_Reset);
}
...
{
	return SysCall(SysCall_Table_Index_BSP_Wdog_Refresh);
}
...
{
	return SysCall(SysCall_Table_Index_Timer_GET_Counter,Counter_MS);
}
